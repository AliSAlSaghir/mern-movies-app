...
const Register = () => {
  ...
  return (
    <div className="pl-[8rem] flex flex-wrap">
      <div className="mr-[4rem] mt-[4rem]">
        ...
        <form className="container w-[30rem]" onSubmit={submitHandler}>
          ...
          <button
            disabled={isLoading}
            type="submit"
            className="px-4 py-2 text-white bg-teal-500 rounded cursor-pointer"
          >
      ...
      <img
        ...
        alt=""
        className="h-[39rem] w-[50%] p-[1rem] xl:block md:hidden sm:hidden rounded-xl"
      />
    </div>
  );
};
