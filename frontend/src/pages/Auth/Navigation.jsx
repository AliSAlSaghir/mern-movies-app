...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-[3.5rem] left-[44rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[21%] px-[2rem] mb-[1.7rem] rounded">
      <section className="flex items-center justify-between">
        ...
        <div className={`relative ${userInfo ? "pr-3" : ""}`}>
          <button
            ref={dropdownRef}
          ...
          {dropdownOpen && userInfo && (
            <ul
              className={`absolute left-0 ml-[-3.5rem]  mt-[-1.5rem] w-[10rem] space-y-2 bg-white text-gray-600  ${
                !userInfo.isAdmin ? "-top-20" : "-top-32"
              }`}
            >
              {userInfo.isAdmin && (
                <>
